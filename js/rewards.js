...
function DoneRedeem() {
  ...
  .get().then((snapshot)=> {
    snapshot.forEach(doc=> {
      ...
      str += '<tr>';
      str += '<td style="line-height: 1.3;">รหัสสินค้า <font color="#f68b1f"><b>'+doc.data().StockName+'</b></font><br>คะแนนที่แลก <font color="#0056ff">'+addCommas(doc.data().PointRedeem)+' คะแนน</font><br>';
      str += 'วันที่แลก <font color="#0056ff">'+doc.data().DateRedeem+'</font><br>วันที่ยืนยัน <font color="#0056ff">'+doc.data().DateConfirm+'</font></td>';
      str += '</tr>';
